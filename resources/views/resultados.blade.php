...
<body class="bg-gray-100">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <h1 class="text-5xl font-extrabold text-center text-gray-900 border-b-4 border-blue-500 inline-block pb-2">Boletos Disponibles</h1>
    ...
    <style>
        .ticket {
            ...
            position: relative;
            overflow: hidden;
            margin-bottom: 20px; /* Espacio entre boletos */
        }
        .ticket::before {
            content: '';
            position: absolute;
    ...
    if (!searchData) {
        ...
        document.getElementById("results-container").innerHTML = '<p class="text-gray-600">No se encontraron datos de búsqueda.</p>';
        return;
    }
    ...
    if (tickets.length > 0) {
        tickets.forEach((ticket, index) => {
            ...
            ticketElement.className = "ticket animate__animated animate__fadeInUp"; // Agregar animación
            ticketElement.style.animationDelay = `${index * 0.2}s`; // Retraso para animación escalonada
