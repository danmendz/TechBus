<div class="max-w-6xl mx-auto p-4 sm:p-6">
    @if($tickets->isEmpty())
        <div class="flex flex-col items-center justify-center min-h-[50vh] text-center py-12 px-4">
            ...
            <a href="{{ route('buscar-corridas') }}" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg shadow-md hover:from-blue-700 hover:to-blue-600 transition-all font-medium flex items-center">
