<div>
    <link href="{{ asset('css/general/auth/authentication-card.css') }}" rel="stylesheet">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-custom-triangle">
            ...
            <div class="px-4 py-2 sm:py-3">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        ...
                        <a class="text-blue-600 decoration-2 focus:outline-none font-medium" href="/login">
                            Inicia sesión aquí
                        </a>
                    </p>
                </div>
                    ...
                    <div class="mt-0">
                        <div class="grid gap-y-4">
                            ...
                            <div class="mt-4">
                                ...
                                <x-input wire:model="surnames" id="surnames" class="block mt-1 w-full" type="text"
                                    name="surnames" required autofocus autocomplete="surnames" />
