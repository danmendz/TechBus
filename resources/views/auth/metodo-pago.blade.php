...
<script async src="https://cse.google.com/cse.js?cx=b4f2947b021ac4b02"></script>
    ...
    <div class="bg-gray-100 py-12">
        <div class="max-w-6xl mx-auto px-6">
              <!-- Título Principal -->
              <h1 class="text-5xl font-extrabold text-center text-gray-900 border-b-4 border-blue-500 inline-block pb-2 animate__animated" data-animation="animate__fadeInDown">
                Métodos de Pago
            </h1>

            <!-- Subtítulo -->
            <p class="text-center text-lg text-gray-700 mt-4 animate__animated" data-animation="animate__fadeInUp">
                ¡Lo más fácil de viajar, es pagar! Hemos creado una nueva experiencia para que elijas entre cientos de destinos 
            ...
            <section class="mt-8 bg-white p-6 rounded-lg shadow-lg animate__animated" data-animation="animate__fadeInRight">
                ...
                <ol class="list-decimal list-inside text-gray-700 text-lg mt-4 space-y-2">
                    ...
                    <li>Acepta nuestros <a href="#" class="text-blue-500 underline">Términos y Condiciones</a> y <a href="#" class="text-blue-500 underline">Aviso de Privacidad</a>.</li>
