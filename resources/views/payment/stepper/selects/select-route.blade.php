...
<body>
    <div class="container mx-auto my-auto">
        <h1 class="text-3xl font-bold text-center mb-12 text-gray-800">Choose Your Destination</h1>
        <!-- Buttons -->
        <div
            class="p-4 border border-gray-300 rounded-lg bg-white shadow-lg bg-cover bg-center backdrop-blur-lg text-black z-0">
