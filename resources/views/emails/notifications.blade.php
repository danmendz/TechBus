                ...
                <table role="presentation" width="100%" max-width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            ...
                            <p style="font-size: 16px; color: #555;">Adjunto encontrarás tu boleto en formato PDF.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 20px 20px 10px;">
                            <p style="font-size: 14px; color: #777;">Si no solicitaste esta notificación, puedes ignorar este mensaje.</p>
                        </td>
                    </tr>
                    <tr>
