                ...
                <div class="mt-6 p-4 border border-gray-300 rounded-lg bg-white shadow-lg backdrop-blur-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select id="origen"
                                class="w-full h-10 px-3 border border-gray-400 rounded-md bg-white text-gray-900 focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="flex items-end">
                            <button type="button"
                                class="w-full h-10 flex justify-center items-center px-4 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500">
                                Buscar viaje
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
